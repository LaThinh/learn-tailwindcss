...
export default function TailwindColorPage() {
  return (
    <div>
      <h1 className="tailwind-title">Tailwind 02: Colors</h1>
      <div>
        ...
        <p className="underline decoration-emerald-500">
        ...
        <form className="form border rounded-lg border-gray-300 px-5 my-5 max-w-md">
          <fieldset className="flex flex-col gap-5 my-4 ">
            <legend className="rounded-md font-semibold mb-3">
              Form Login Demo
            </legend>
            <input
              type="text"
        ...
        <div className="flex gap-4">
          <p>Shadow</p>
          <button className="shadow-lg bg-cyan-500 shadow-cyan-500 p-3 rounded-[20px] hover:bg-red-400">
            Apply
          </button>
          <button className="shadow-lg bg-cyan-500 shadow-purple-500/60">
            Subscribe
          </button>
          <button className="shadow-lg bg-green-500 px-4 py-2 text-white font-semibold rounded-[20px] shadow-gray-400 hover:bg-green-600">
            Subscribe
          </button>
        </div>
