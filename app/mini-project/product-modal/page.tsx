...
export default function ProductModal() {
  return (
    <div>
      <div className="flex items-center justify-center min-h-[calc(100vh-100px)] bg-slate-100">
        {/* <!-- Card Container --> */}
        <div className="flex flex-col p-6 m-3 space-y-10 bg-white rounded-2xl shadow-2xl md:flex-row md:space-y-0 md:space-x-10 md:m-0 md:p-16">
          ...
          <div>
            <img
              ...
              alt=""
              className="mx-auto duration-200 w-60 hover:scale-105 cursor-pointer"
            />
          </div>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
              ...
              <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
                <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150 hover:bg-gray-200">
                  <img src="/assets/images/weight.png" alt="" className="w-8" />
                  <span>Add to cart</span>
                </button>

                <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150 hover:bg-blue-200">
                  <img src="/assets/images/heart.png" alt="" className="w-8" />
